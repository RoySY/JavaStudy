...
//        	tempChar = q.poll();
//        	
//        	if (q.isEmpty() || (!q.isEmpty() && tempChar != q.peek())) {
//        		
//        		if (hm.get(tempChar) == null) {
//                	hm.put(tempChar, 1);
//                } else {
//                	tempCnt = hm.get(tempChar) + 1;
//                	hm.put(tempChar, tempCnt);
//                }
//        	} else {
//        		hs.add(tempChar); // 마지막 바로 전 알파벳과 마지막 알파벳이 같다면 여기서 추가됐을 것
//        	}
//        }
//        
//        for (char c : hs) {
//        	hm.remove(c); // 연속된 알파벳인 경우 hm에서 제거
//        }
//        
//        for (char key : hm.keySet()) {
//        	
//        	if (hm.get(key) > 1) { // 2회 이상 포함된 알파벳
//        		list.add(key);
//        	}
//        }
//        
